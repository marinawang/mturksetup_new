...
app.get('/pretask2/:input', function (req, res) {
  ...
  res.send('<!DOCTYPE html>\n'+
		  ...
		  '<script src=\'https://ajax.googleapis.com/ajax/libs/jquery/1.10.2/jquery.min.js\'></script>\n'+
		  '<div id="nav">\n'+
		  '<object type="text/html" data="http://luoyang.lti.cs.cmu.edu:8000/task'+(uid-1)%4+'.html" width="100%" height="800px" style="overflow:auto;border:5px ridge blue"></object>\n'+
		  '</div>\n'+
		  '<div id="section">\n'+
...
//	var forumurl =	"http://baldwin-cf.isri.cmu.edu:8500/forum/security/index.cfm?uid="+cntuid+"&key="+nickname;
 ...
 res.send('<html>\n<head>\n<style>\n .form { visibility: hidden;}\n'+
		...
		'var futureDate  = new Date(Date.UTC(2016, 9, 12, 15, 25, 0));\n'+
...
//	   		link = "http://bazaar-chat.lti.cs.cmu.edu:80/login?roomName=mturk&roomId=4111&mturkid="+userid+"&username="+nickname+"&perspective="+(userid-1)%4;
	   		//if(data%2==0){
	   		link="http://bazaar.lti.cs.cmu.edu:80/login?roomName=mturk&roomId="+prefix+data+"&mturkid="+userid+"&username="+nickname+"&perspective="+(userid-1)%4+"&html=xu";	
...
//	   		link = "http://bazaar.lti.cs.cmu.edu:8000/login?roomName=new19&roomId="+prefix+data+"&mturkid="+userid+"&username="+nickname+"&perspective="+(userid-1)%4;
	   		//}
//	   		else{
